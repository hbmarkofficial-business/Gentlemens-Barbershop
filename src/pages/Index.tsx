  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Gentlemens Barbershop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Gentlemens Barbershop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
          content="Barbershop, Herrenfriseur, Haarschnitt, Bartpflege, Rasur, Berlin"
        />
        <link rel="canonical" href="https://gentlemanscut.de" />

        {/* Open Graph */}
        <meta property="og:title" content="Gentlemens Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Gentlemens Barbershop | Premium Barbershop Berlin" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/gentlemensbarbershop",
              "https://www.instagram.com/gentlemensbarbershop"
            ]
          })}
        </script>
      </Helmet>
